...
export default function Main() {
  ...
  return (
    <main className="w-full p-8 font-black">
      <div className="flex flex-col lg:flex-row w-full mx-auto text-white gap-12">
        <div className="flex-1">
          <h1 className="hidden md:block text-3xl">최고의 실력을 가진 외국인 인재를 찾고 계신가요?</h1>
          <br />
          <p className="text-xl text-[#FFFFFFCC]">법률 및 인사관리 부담없이 1주일 이내에 원격으로 채용해보세요.</p>
          <br />
          ...
          <div className="hidden md:flex gap-4">
            <div className="flex-1">
              <hr />
              <p className="text-base mt-1">평균 월 120만원</p>
              <p className="text-sm mt-2 text-[#FFFFFFCC]">임금을 해당 국가를 기준으로 계산합니다.</p>
            </div>
            <div className="flex-1">
              <hr />
              <p className="text-base mt-1">최대 3회 인력교체</p>
              <p className="text-sm mt-2 text-[#FFFFFFCC]">막상 채용해보니 맞지 않아도 걱정하지 마세요.</p>
            </div>
            <div className="flex-1">
              <hr />
              <p className="text-base mt-1">평균 3일, 최대 10일</p>
              <p className="text-sm mt-2 text-[#FFFFFFCC]">급하게 사람이 필요한 경우에도 빠른 채용이 가능합니다.</p>
            </div>
          </div>
        </div>
      ...
      <div className="hidden md:block -mr-8 overflow-hidden mt-8">
